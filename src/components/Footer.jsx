...
const Footer = () => {
  return (
    <section className='w-full bg-gradient-to-r from-yellow-50 to-teal-50 py-6 px-5 pb-10 mt-12'>
<div className='flex items-center justify-around flex-wrap gap-10'>
<ul className='flex flex-col gap-3 text-sm text-[#777777] max-[325px]:text-center'>
            <li>About Us</li>
            <li>Privacy</li>
        ...
        <div className='flex flex-col gap-5 justify-center max-[681px]:flex-row'>
