  ...
  return (
    ...
    <section className='w-full h-fit py-7 relative'>
        ...
        <div className='self-start absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 '>
            <h1 className='text-5xl font-bold text-white'>Welcome to Poetry Haven, Inc.</h1>
            <p className='text-center text-md text-[#ccc] opacity-[90%]'>Discover, Share, and Celebrate the Art of Poetry</p>
        </div>
    </section>
    <section>
